					...
					{						
						...
						?>					
							...
							}else
							{
								...
								document.getElementById('paypal_info').innerHTML = '<form method="POST" name="submit_payment" id="submit_payment" action="<?php echo tgt_free_payment_link (); ?>" class="book-form"> <input type="hidden" name="payment_method" id="payment_method" value="cash">'
																					...
																					?>
																					+ '<p class="button"><button type="submit" name="submit_continue" id="butt_save" value="<?php _e( 'Confirm & Pay', 'hotel' ); ?>" class="hidden-txt"><?php _e( 'Confirm & Pay', 'hotel' ); ?></button></p></form>';
								document.getElementById('u_id').value	= res;																
							}
						<?php
						}
