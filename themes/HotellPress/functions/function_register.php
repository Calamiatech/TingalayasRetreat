 ...
 */
function tgt_get_countries($file){
	//create dom document
	$doc = new DOMDocument();
	$doc->load($file);
	...
	if (!empty($countries))
	{
		foreach ($countries as $country)
		{
			...
			foreach ($cities as $city) {
				//write city element into cities list
				$resultCities[] = $city->getAttribute('value');
			}
			
			//write cities list into country
			$result[$country->getAttribute('value')] = $resultCities;
		}
		//return countries
		return $result;
	}
