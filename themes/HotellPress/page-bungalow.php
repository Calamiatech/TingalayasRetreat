...
#if ( ! isset( $_REQUEST['content'] ) || ( $_REQUEST['content'] != 1 && $_REQUEST['content'] != 'full' ) || ! have_posts() ) :
...
<?php if ( $_REQUEST['content'] == 'full' ) : get_header( 'pop' ); endif; ?>
	...
	<?php if ( get_image( 'images_image', 1, 1, 0, get_the_ID() ) != '' ) : ?>
		...
		<div class="bungalows-gallery">
			...
			<div class="carousel-container">
				...
				<div id="tab-<?php echo get_the_ID(); ?>-carousel" class="tab-carousel">
					...
					<?php foreach ( $images as $image ) : ?>
						...
						<div class="carousel-feature"><a href="#image-<?php echo $image; ?>"><span class="image"><img src="<?php echo $src; ?>" title="Click each image to expand for full view" alt="Click each image to expand for full view" class="carousel-image" /></span></a></div>
...
<?php if ( $_REQUEST['content'] == 'full' ) : get_footer( 'pop' ); endif; ?>