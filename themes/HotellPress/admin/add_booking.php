				...
				<div class="content submission" id="jobs" >				    				          
                    ...
                    <span><?php _e('Country :','hotel');?>*</span>
						<div class="inputStyle">
							...
							{
							?>
                            	<option value="<?php echo $k; ?>" <?php if($cus_add['country'] == $k) echo 'selected="selected"'; if( isset($_POST['country']) && $_POST['country']== $k) echo 'selected="selected"'; ?>><?php echo $k; ?></option>
                            <?php	
							}
							?>
                            </select>							
