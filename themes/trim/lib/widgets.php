...
class TRim_Vcard_Widget extends WP_Widget {
  ...
  function widget($args, $instance) {
    $cache = wp_cache_get('widget_trim_vcard', 'widget');
    ...
    $title = apply_filters('widget_title', empty($instance['title']) ? __('vCard', 'trim') : $instance['title'], $instance, $this->id_base);
  ...
  <?php
    ...
    wp_cache_set('widget_trim_vcard', $cache, 'widget');
  }
  ...
  function update($new_instance, $old_instance) {
    ...
    if (isset($alloptions['widget_trim_vcard'])) {
      delete_option('widget_trim_vcard');
    }
  ...
  function flush_widget_cache() {
    wp_cache_delete('widget_trim_vcard', 'widget');
  }
  ...
  function form($instance) {
    ...
    ?>
    <p>
      <label for="<?php echo esc_attr($this->get_field_id($name)); ?>"><?php _e("{$label}:", 'trim'); ?></label>
