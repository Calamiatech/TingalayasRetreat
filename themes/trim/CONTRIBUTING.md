...
* Please **do not** use the issue tracker for personal support requests (use the
  [TRim Discourse](http://discourse.trim.io/)).
...
3. **Isolate the problem to TRim** &mdash; make sure that the code in the TRim
...
fits with the scope and aims of TRim. It's up to *you* to make a strong
case to convince the TRim developers of the merits of this feature. Please
...
time working on something that the developers might not want to merge into TRim.
...
1. [Fork](http://help.github.com/fork-a-repo/) TRim, clone your fork,
